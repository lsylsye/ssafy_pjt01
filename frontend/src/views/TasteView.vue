    ...
    <div class="container">
      ...
      <section class="test-banner">
        ...
        <div class="banner-text">
          <h1 class="banner-title">내 독서 취향은 무슨 나무일까요?</h1>
...
.page{
  /* background: var(--bg); Removed to show bg-blobs from layout */
...
/* 1. 취향 테스트 배너 */
.test-banner {
  /* Navy and Mint dynamic gradient */
  background: linear-gradient(-45deg, #191f28, #1a355e, #4fd1c5, #191f28);
