<template>
  <section class="review-section">
    <div class="container">
      ...
      <div v-else class="review-swiper-container">
        <swiper
          :slides-per-view="1"
          :space-between="20"
          :autoplay="{
        ...
        >
          <swiper-slide v-for="r in reviews" :key="r.id">
            <div class="glass-panel review-item" @click="goReviewDetail(r.id)">
              <div class="reviewer">
...
.name{ font-weight: 800; font-size: 0.9rem; color: #191f28; }
.time{ font-size: 0.75rem; color: #b0b8c1; font-weight: 500; margin-top: 2px; }
