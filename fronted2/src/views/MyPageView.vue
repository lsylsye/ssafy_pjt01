...
import { getMyProfile, getUserProfile, updateMyProfile, toggleFollow, getFollowers, getFollowing, getMyPosts, getMyComments } from "@/api/mypage";
...
async function loadMyActivity() {
  try {
    ...
    console.error("Failed to load my activity", err);
  }
}
...
<template>
  <div class="mypage-container">
    ...
    <div v-else class="container">
      ...
      <!-- 내 서재 바로가기 -->
      <router-link to="/mylib" class="link-banner">
      ...
      <div v-if="isMe" class="card activity-card">
        ...
        <div class="activity-content">
          ...
          <div v-if="activeTab === 'posts'" class="activity-list">
            ...
            >
              <div class="activity-type">{{ post.type_name }}</div>
          ...
          <div v-if="activeTab === 'comments'" class="activity-list">
            ...
            >
              <div class="activity-type">{{ comment.type === 'FREE' ? '자유' : '리뷰' }}</div>
