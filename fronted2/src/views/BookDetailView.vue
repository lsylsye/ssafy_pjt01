      ...
      <aside class="review-aside">
        ...
        <div class="side-scroll-area">
          ...
          <div v-else-if="book.reviews && book.reviews.length > 0" class="review-list">
            <div v-for="rev in book.reviews" :key="rev.id" class="r-card">
              <div class="r-top">
                <div class="r-avatar" @click="goProfile(rev.user_id)">
                  <img v-if="rev.user_profile_image" :src="getProfileImage(rev.user_profile_image)" />
                  <User v-else :size="14" />
                </div>
                <div class="r-meta">
                  <div class="r-nick" @click="goProfile(rev.user_id)">{{ rev.user_nickname }}</div>
                  <div class="r-stars">
